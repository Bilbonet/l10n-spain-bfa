...
class L10nEsBfaMod140ReportExportToBob(models.TransientModel):
    _name = "l10n.es.bfa.mod140.report.export_to_bob"
    _description = "Export Report to BOB Format"
    ...
    def action_get_file(self):
        """Action that exports the data into a BOB formatted text file.
